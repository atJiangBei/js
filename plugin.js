...
var lunarInfo = new Array(
	...
	0x14b63);
var hanshu = {
	"2007": [196, 206, 226, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2008": [201, 211, 221, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2009": [195, 205, 225, 356, 365, 8, 17, 26, 35, 44, 53, 62],
	"2010": [200, 210, 220, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2011": [195, 205, 225, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2012": [200, 210, 220, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2013": [194, 204, 224, 356, 365, 8, 17, 26, 35, 44, 53, 62],
	"2014": [199, 209, 219, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2015": [194, 204, 224, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2016": [199, 209, 229, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2017": [193, 203, 223, 356, 365, 8, 17, 26, 35, 44, 53, 62],
	"2018": [198, 208, 228, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2019": [193, 203, 223, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2020": [198, 208, 228, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2021": [192, 202, 222, 356, 365, 8, 17, 26, 35, 44, 53, 62],
	"2022": [197, 207, 227, 355, 364, 8, 17, 26, 35, 44, 53, 62],
	"2023": [192, 202, 222, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2024": [197, 207, 227, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2025": [201, 211, 221, 356, 365, 8, 17, 26, 35, 44, 53, 62],
	"2026": [196, 206, 226, 355, 364, 8, 17, 26, 35, 44, 53, 62],
	"2027": [201, 211, 221, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2028": [196, 206, 226, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2029": [200, 210, 220, 356, 365, 8, 17, 26, 35, 44, 53, 62],
	"2030": [195, 205, 225, 355, 364, 8, 17, 26, 35, 44, 53, 62],
	"2031": [200, 210, 220, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2032": [195, 205, 225, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2033": [199, 209, 219, 356, 365, 8, 17, 26, 35, 44, 53, 62],
	"2034": [194, 204, 224, 355, 364, 8, 17, 26, 35, 44, 53, 62],
	"2035": [199, 209, 219, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2036": [194, 204, 224, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2037": [198, 208, 228, 356, 365, 8, 17, 26, 35, 44, 53, 62],
	"2038": [193, 203, 223, 355, 364, 8, 17, 26, 35, 44, 53, 62],
	"2039": [198, 208, 228, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2040": [193, 203, 223, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2041": [197, 207, 227, 356, 365, 8, 17, 26, 35, 44, 53, 62],
	"2042": [192, 202, 222, 355, 364, 8, 17, 26, 35, 44, 53, 62],
	"2043": [197, 207, 227, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2044": [202, 212, 222, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2045": [196, 206, 226, 356, 365, 8, 17, 26, 35, 44, 53, 62],
	"2046": [201, 211, 221, 355, 364, 8, 17, 26, 35, 44, 53, 62],
	"2047": [196, 206, 226, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2048": [201, 211, 221, 356, 365, 9, 18, 27, 36, 45, 54, 63],
	"2049": [195, 205, 225, 356, 365, 8, 17, 26, 35, 44, 53, 62],
	"2050": [200, 210, 220, 355, 364, 8, 17, 26, 35, 44, 53, 62]
};
...
var JQYearDate = {
	"2010": [4, 19, 34, 49, 64, 79, 94, 109, 124, 140, 156, 171, 187, 203, 218, 234, 250, 265, 280, 295, 310, 325, 340,
		355
	],
	"2011": [5, 19, 34, 49, 64, 79, 94, 109, 125, 140, 156, 172, 187, 203, 219, 234, 250, 265, 280, 296, 311, 326, 340,
		355
	],
	"2012": [5, 20, 34, 49, 64, 79, 94, 110, 125, 140, 156, 172, 188, 203, 219, 235, 250, 265, 281, 296, 311, 326, 341,
		355
	],
	"2013": [4, 19, 34, 48, 63, 78, 93, 109, 124, 140, 155, 171, 187, 202, 218, 234, 249, 265, 280, 295, 310, 325, 340,
		355
	],
	"2014": [4, 19, 34, 49, 64, 79, 94, 109, 124, 140, 156, 171, 187, 203, 218, 234, 250, 265, 280, 295, 310, 325, 340,
		355
	],
	"2015": [5, 19, 34, 49, 64, 79, 94, 109, 125, 140, 156, 172, 187, 203, 219, 234, 250, 265, 280, 296, 311, 325, 340,
		355
	],
	"2016": [5, 19, 34, 49, 64, 79, 94, 109, 125, 140, 156, 172, 188, 203, 219, 235, 250, 265, 281, 296, 311, 326, 341,
		355
	],
	"2017": [4, 19, 33, 48, 63, 78, 93, 109, 124, 140, 155, 171, 187, 202, 218, 234, 249, 265, 280, 295, 310, 325, 340,
		355
	],
	"2018": [4, 19, 34, 49, 63, 79, 94, 109, 124, 140, 156, 171, 187, 203, 218, 234, 250, 265, 280, 295, 310, 325, 340,
		355
	],
	"2019": [4, 19, 34, 49, 64, 79, 94, 109, 125, 140, 156, 171, 187, 203, 219, 234, 250, 265, 280, 296, 311, 325, 340,
		355
	],
	"2020": [5, 19, 34, 49, 64, 79, 94, 109, 125, 140, 156, 172, 187, 203, 219, 234, 250, 265, 281, 296, 311, 326, 341,
		355
	],
	"2021": [4, 19, 33, 48, 63, 78, 93, 109, 124, 140, 155, 171, 187, 202, 218, 234, 249, 265, 280, 295, 310, 325, 340,
		354
	],
	"2022": [4, 19, 34, 49, 63, 78, 94, 109, 124, 140, 156, 171, 187, 203, 218, 234, 249, 265, 280, 295, 310, 325, 340,
		355
	],
	"2023": [4, 19, 34, 49, 64, 79, 94, 109, 125, 140, 156, 171, 187, 203, 219, 234, 250, 265, 280, 296, 311, 325, 340,
		355
	],
	"2024": [5, 19, 34, 49, 64, 79, 94, 109, 125, 140, 156, 172, 187, 203, 219, 234, 250, 265, 281, 296, 311, 326, 340,
		355
	],
	"2025": [4, 19, 33, 48, 63, 78, 93, 109, 124, 140, 155, 171, 187, 202, 218, 234, 249, 265, 280, 295, 310, 325, 340,
		354
	],
	"2026": [4, 19, 34, 48, 63, 78, 94, 109, 124, 140, 155, 171, 187, 203, 218, 234, 249, 265, 280, 295, 310, 325, 340,
		355
	],
	"2027": [4, 19, 34, 49, 64, 79, 94, 109, 125, 140, 156, 171, 187, 203, 219, 234, 250, 265, 280, 295, 310, 325, 340,
		355
	],
	"2028": [5, 19, 34, 49, 64, 79, 94, 109, 125, 140, 156, 172, 187, 203, 219, 234, 250, 265, 281, 296, 311, 326, 340,
		355
	],
	"2029": [4, 19, 33, 48, 63, 78, 93, 109, 124, 140, 155, 171, 187, 202, 218, 234, 249, 265, 280, 295, 310, 325, 340,
		354
	],
	"2030": [4, 19, 34, 48, 63, 78, 94, 109, 124, 140, 155, 171, 187, 203, 218, 234, 249, 265, 280, 295, 310, 325, 340,
		355
	]
};
...
function DateCalculate(calculateDate, number, type) {
	...
	switch (type) {
		...
		case "w":
			...
			break;
		case "M":
			calculateResult = new Date(calculateDate.getFullYear(), (calculateDate.getMonth()) + parseInt(number), calculateDate
				.getDate(),
				calculateDate.getHours(), calculateDate.getMinutes(), calculateDate.getSeconds());
			break;
		case "y":
			calculateResult = new Date(calculateDate.getFullYear() + parseInt(number), (calculateDate.getMonth()), calculateDate
				.getDate(),
				calculateDate.getHours(), calculateDate.getMinutes(), calculateDate.getSeconds());
			break;
	}
...
(function(s) {
	...
	for (var r = CryptoJS, q = r.lib, v = q.WordArray, t = q.Hasher, q = r.algo, a = [], u = 0; 64 > u; u++) a[u] =
