...
$(function() {
	...
	var ay = "//minipc.eastday.com/ccms/777f39c173/777f39c173_330_944_v1.json",
...
function jsonp(url,cb){
	...
	function y() {
		M.html("");
		F.show()
		jsonp("https://ccms.dftoutiao.com/backend/api/777f39c173/777f39c173_330_944_v1_jsonp.json",function(data){
			console.log(data)
			P(data)
			F.hide()
		})
		...
		for (var aY = 0; aY < a0; aY++) {
			...
			if (((aY == 3 || aY == 5 || aY == 8) || ((aY > 8) && ((aY - 8) % 6) == 0))) {
				...
				M.append('<li class="tt-news-item tt-news-item-s1 dspads ' + uedclass + '"  id="h5_' + h5_id +
					...
					'" data-inviewbackurl="' + aW.inviewbackurl + '"  data-isclickurl="' + aW.isclickbackurl +
